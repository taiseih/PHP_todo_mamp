...
if(!function_exists('apc_cache_info')) {
	echo "No cache info available, APC does not appear to be running. Please check the PHP settings in MAMP (PRO) for the selected cache module. If you are running PHP 7 make sure you have apcu.so AND apc.so enabled in the PHP.ini file. If you are running PHP 8 please use apc-8.php for cache info.";
  exit;
}
