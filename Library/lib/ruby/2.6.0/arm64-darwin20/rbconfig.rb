...
module RbConfig
  ...
  TOPDIR = File.dirname(__FILE__).chomp!("/lib/ruby/2.6.0/arm64-darwin20")
  ...
  CONFIG["try_header"] = ""
  CONFIG["CC_VERSION_MESSAGE"] = "Apple clang version 12.0.0 (clang-1200.0.32.29)\nTarget: arm64-apple-darwin20.3.0\nThread model: posix\nInstalledDir: /Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/bin"
  ...
  CONFIG["host_os"] = "darwin20.3.0"
  CONFIG["host_vendor"] = "apple"
  CONFIG["host_cpu"] = "arm"
  CONFIG["host"] = "arm-apple-darwin20.3.0"
  CONFIG["RUBY_VERSION_NAME"] = "$(RUBY_BASE_NAME)-$(ruby_version)"
  CONFIG["RUBYW_BASE_NAME"] = "rubyw"
  CONFIG["RUBY_BASE_NAME"] = "ruby"
  CONFIG["build_os"] = "darwin20.3.0"
  CONFIG["build_vendor"] = "apple"
  CONFIG["build_cpu"] = "arm"
  CONFIG["build"] = "arm-apple-darwin20.3.0"
